...
public class AmazonClient {
	 ...
	 * @param fileName
	 * 
	 * @description This method uploads file to S3 bucketName: The bucket name
	 * where we want to upload object key: This is the full path to
	 * the file file: The actual file containing the data to be
	 * uploaded
	 * 
	 * @param file
	 */
